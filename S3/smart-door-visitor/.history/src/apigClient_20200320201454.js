...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ho4v9bk60a.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.chatbotPost = function (params, body, additionalParams) {
        ...
        var chatbotPostRequest = {
            ...
            path: pathComponent + urlTemplate["default"].parse('/chatbot').expand(utils.parseParametersToObject(params, [])),
